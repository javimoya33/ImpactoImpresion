								...
								<div class="bd-header__top3-info">
									<ul>
										<?php if(isset($printress_redux_demo['header_mail_address']) && $printress_redux_demo['header_mail_address']!=''){?>
											<li><a href="mailto:<?php echo wp_specialchars_decode(esc_attr($printress_redux_demo['header_mail_address']));?>"><i class="fal fa-envelope"></i> <?php echo wp_specialchars_decode(esc_attr($printress_redux_demo['header_mail_address']));?></a></li>
										<?php } ?>
										<?php if(isset($printress_redux_demo['header_phone_number']) && $printress_redux_demo['header_phone_number']!=''){?>
											<li><a href="tel:<?php echo wp_specialchars_decode(esc_attr($printress_redux_demo['header_phone_number']));?>"><i class="fal fa-phone"></i> <?php echo wp_specialchars_decode(esc_attr($printress_redux_demo['header_phone_number']));?></a></li>
										<?php } ?>
									</ul>
								</div>
							</div>
