<?php $printress_redux_demo = get_option('redux_demo');?> 
	<footer>
		<div class="bd-footer__top black-bg pt-165 pb-60">
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-xl-4 col-lg-4 d-none d-lg-block">
						<div class="bd-footer__logo1 mb-20">
							<a href="<?php echo esc_url(home_url('/')); ?>">
								...
								<?php } else{ ?>
									<img src="<?php echo get_template_directory_uri();?>/assets/img/logo/footer-logo.png" alt="<?php bloginfo( 'name' ); ?>">
								<?php } ?>
							</a>
						</div>
					</div>
					<div class="col-xl-4 col-lg-4 col-md-6">
						<div class="bd-footer-social mb-20">
							<ul>
