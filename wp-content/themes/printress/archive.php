...
?>
<main>
	<section class="page-title-area breadcrumb-spacing" data-background="<?php echo esc_url($printress_redux_demo['arch_bg']['url']); ?>">
		<div class="container">
			<div class="row">
				<div class="col-xxl-12">
					<div class="page-title-wrapper">
						<h3 class="page-title mb-25">
							<?php if(isset($printress_redux_demo['arch_title']) && $printress_redux_demo['arch_title']!=''){?>
							<?php echo wp_specialchars_decode(esc_attr($printress_redux_demo['arch_title']));?>
							<?php }else{?>
							<?php echo esc_html__( 'All post by archive', 'printress' );
							}?>
							<?php printf( esc_html__( ' %s', 'printress' ), get_the_archive_title() );?>
						</h3>
					</div>
				</div>
			</div>
